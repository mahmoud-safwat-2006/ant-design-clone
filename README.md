...
Bash
git clone [https://github.com/mahmoud-safwat-2006/ant-design-clone.git](https://github.com/mahmoud-safwat-2006/ant-design-clone.git)
...
🛣️ Roadmap
[x] Initial Project Setup & Folder Architecture

[x] Global Styles & Theme Variables Configuration

[x] Pixel-Perfect Header & Navigation Implementation

[x] Dynamic Dark/Light Mode Integration
...
👨‍💻 Developer
Mahmoud Safwat
Full-Stack & Mobile Developer | IT Trainee at Faculty of Computers and Information, Mansoura University.

GitHub: @mahmoud-safwat-2006

Philosophy: Writing clean, scalable code and delivering high-fidelity user experiences.
